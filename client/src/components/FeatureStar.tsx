...
export default function FeatureStar({ 
  ...
  return (
    <>
      ...
      {/* POPUP PORTAL - ALWAYS CENTERED */}
      {isHovered && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center">
          <div className="absolute inset-0 bg-black/70 backdrop-blur-sm" />
          <motion.div
            className="relative bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-6 m-4 max-w-md w-full max-h-[80vh] overflow-y-auto"
