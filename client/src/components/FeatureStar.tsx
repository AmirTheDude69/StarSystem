    ...
    <>
      ...
      {isHovered && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center">
          ...
          {/* Centered popup */}
          <motion.div
            className="relative w-96 max-w-[90vw] max-h-[80vh] bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-6 shadow-2xl overflow-auto"
